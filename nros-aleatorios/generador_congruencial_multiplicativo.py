...
# Descripción: Este script implementa un generador de números aleatorios utilizando el método congruencial multiplicativo.

def generador_nros_aleatorios(seed, a, m, n):
    """
    Genera una lista de números aleatorios utilizando el método congruencial multiplicativo.
...
if __name__ == "__main__":
    ...
    numeros_aleatorios = generador_nros_aleatorios(seed, a, m, n)
    
    # Guardar los números aleatorios en un archivo CSV
    guardar_nros_aleatorios_en_csv(numeros_aleatorios, 'numeros_aleatorios_metodo_multiplicativo.csv')
    
    print("Números aleatorios generados y guardados en 'numeros_aleatorios_metodo_multiplicativo.csv'")
