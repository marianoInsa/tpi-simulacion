...
def simular_politica_produccion(
    ...
    print(f"Producción igual al promedio de los últimos {(dias_promedio)} días")
    print("="*60)
...
if __name__ == "__main__":
    ...
    print(f"  - Se produce teniendo en cuenta el promedio de los últimos {(dias_promedio)} días.")
